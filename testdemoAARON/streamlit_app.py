...
def main():
    ...
    if not st.session_state.logged_in:
        # Login Page
        username = st.text_input("Username", value=st.session_state.input_username)
        password = st.text_input("Password", type="password", value=st.session_state.input_password)
